...
namespace RPGM.Gameplay
{
    ...
    public class Quest : MonoBehaviour
    {
        ...
        public GameObject[] disableOnQuestStart;
        ...
        void Awake()
        {
            ...
            {
                SetAllActive(enableOnQuestStart, false);
        ...
        private void SetAllActive(GameObject[] gameObjects, bool active)
        {
            if (gameObjects != null)
        ...
        public void OnStartQuest()
        {
            ...
            SetAllActive(enableOnQuestStart, true);
            SetAllActive(disableOnQuestStart, false);
        ...
        public void RewardItemsToPlayer()
        {
            ...
            {
                MessageBar.Show($"Вы получили: {i.name} x {i.count}");
